...
- (void)viewDidLoad
{
    // What does this do?
    [super viewDidLoad];
    self.title = self.agent.coverName;
...
- (void)configureView
{
    ...
    if (self.agent)
    {
        ...
        //
        NSString *realName = self.realNameLabel.text;
        NSArray *fullName = [realName componentsSeparatedByString:@" "];
        ...
        //     string?
        //
        self.greetingTextView.text = [NSString stringWithFormat:@"Agent %@", lastName];
        ...
        //*** I believe I already did ^this^ on lines 37-39 (???) ***
